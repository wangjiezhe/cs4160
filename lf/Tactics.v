...
(* [apply] does things more than [rewrite], it can also be easily used with
...
Proof.
  ...
  - destruct m.
    + discriminate.
    + intros H. rewrite <- plus_n_Sm in H. rewrite <- plus_n_Sm in H.
...
Proof.
  ...
  - destruct n.
    + discriminate.
    + simpl. intro H. apply IHl. injection H as H'. apply H'.
Qed.
(** [] *)
...
Proof.
  ...
  - simpl.
    ...
    + intros lf H. injection H as H1 H2.
      rewrite <- H1. apply Testn.
    + apply IHl'.
Qed.
(** [] *)
...
Proof.
  ...
  - simpl.
    destruct (test n) eqn:Testn.
    + unfold existsb'. simpl. rewrite Testn. simpl. reflexivity.
    + unfold existsb'. simpl. rewrite Testn. simpl. rewrite IHl'. reflexivity.
Qed.
