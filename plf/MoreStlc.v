...
Proof with eauto.
  ...
  - rename s into y, U into T2.
    destruct (eqb_spec x y); eapply T_Let...
    + subst. rewrite update_shadow in H6. assumption.
    + apply IHt2. erewrite update_permute in H6 by auto. assumption.
